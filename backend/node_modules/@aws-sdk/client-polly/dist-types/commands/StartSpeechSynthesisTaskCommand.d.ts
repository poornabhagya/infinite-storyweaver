...
declare const StartSpeechSynthesisTaskCommand_base: {
    new (input: StartSpeechSynthesisTaskCommandInput): import("@smithy/core/client").CommandImpl<StartSpeechSynthesisTaskCommandInput, StartSpeechSynthesisTaskCommandOutput, import("..").PollyClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartSpeechSynthesisTaskCommandInput): import("@smithy/core/client").CommandImpl<StartSpeechSynthesisTaskCommandInput, StartSpeechSynthesisTaskCommandOutput, import("..").PollyClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
