...
declare const ListSpeechSynthesisTasksCommand_base: {
    new (input: ListSpeechSynthesisTasksCommandInput): import("@smithy/core/client").CommandImpl<ListSpeechSynthesisTasksCommandInput, ListSpeechSynthesisTasksCommandOutput, import("..").PollyClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListSpeechSynthesisTasksCommandInput]): import("@smithy/core/client").CommandImpl<ListSpeechSynthesisTasksCommandInput, ListSpeechSynthesisTasksCommandOutput, import("..").PollyClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
