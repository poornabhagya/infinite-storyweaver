...
declare const GetSpeechSynthesisTaskCommand_base: {
    new (input: GetSpeechSynthesisTaskCommandInput): import("@smithy/core/client").CommandImpl<GetSpeechSynthesisTaskCommandInput, GetSpeechSynthesisTaskCommandOutput, import("..").PollyClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetSpeechSynthesisTaskCommandInput): import("@smithy/core/client").CommandImpl<GetSpeechSynthesisTaskCommandInput, GetSpeechSynthesisTaskCommandOutput, import("..").PollyClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
