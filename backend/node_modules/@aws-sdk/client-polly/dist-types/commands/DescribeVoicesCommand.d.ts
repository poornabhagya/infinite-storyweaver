...
declare const DescribeVoicesCommand_base: {
    new (input: DescribeVoicesCommandInput): import("@smithy/core/client").CommandImpl<DescribeVoicesCommandInput, DescribeVoicesCommandOutput, import("..").PollyClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeVoicesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeVoicesCommandInput, DescribeVoicesCommandOutput, import("..").PollyClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
