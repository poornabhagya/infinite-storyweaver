...
declare const PutLexiconCommand_base: {
    new (input: PutLexiconCommandInput): import("@smithy/core/client").CommandImpl<PutLexiconCommandInput, PutLexiconCommandOutput, import("..").PollyClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutLexiconCommandInput): import("@smithy/core/client").CommandImpl<PutLexiconCommandInput, PutLexiconCommandOutput, import("..").PollyClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
