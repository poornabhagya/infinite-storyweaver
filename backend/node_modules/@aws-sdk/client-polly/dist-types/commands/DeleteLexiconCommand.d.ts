...
declare const DeleteLexiconCommand_base: {
    new (input: DeleteLexiconCommandInput): import("@smithy/core/client").CommandImpl<DeleteLexiconCommandInput, DeleteLexiconCommandOutput, import("..").PollyClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteLexiconCommandInput): import("@smithy/core/client").CommandImpl<DeleteLexiconCommandInput, DeleteLexiconCommandOutput, import("..").PollyClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
