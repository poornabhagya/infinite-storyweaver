...
declare const GetLexiconCommand_base: {
    new (input: GetLexiconCommandInput): import("@smithy/core/client").CommandImpl<GetLexiconCommandInput, GetLexiconCommandOutput, import("..").PollyClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetLexiconCommandInput): import("@smithy/core/client").CommandImpl<GetLexiconCommandInput, GetLexiconCommandOutput, import("..").PollyClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
