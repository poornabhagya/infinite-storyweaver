...
declare const SynthesizeSpeechCommand_base: {
    new (input: SynthesizeSpeechCommandInput): import("@smithy/core/client").CommandImpl<SynthesizeSpeechCommandInput, SynthesizeSpeechCommandOutput, import("..").PollyClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SynthesizeSpeechCommandInput): import("@smithy/core/client").CommandImpl<SynthesizeSpeechCommandInput, SynthesizeSpeechCommandOutput, import("..").PollyClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
