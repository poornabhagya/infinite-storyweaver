...
declare const ListLexiconsCommand_base: {
    new (input: ListLexiconsCommandInput): import("@smithy/core/client").CommandImpl<ListLexiconsCommandInput, ListLexiconsCommandOutput, import("..").PollyClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListLexiconsCommandInput]): import("@smithy/core/client").CommandImpl<ListLexiconsCommandInput, ListLexiconsCommandOutput, import("..").PollyClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
