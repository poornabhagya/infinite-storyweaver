...
declare const StartSpeechSynthesisStreamCommand_base: {
    new (input: StartSpeechSynthesisStreamCommandInput): import("@smithy/core/client").CommandImpl<StartSpeechSynthesisStreamCommandInput, StartSpeechSynthesisStreamCommandOutput, import("..").PollyClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartSpeechSynthesisStreamCommandInput): import("@smithy/core/client").CommandImpl<StartSpeechSynthesisStreamCommandInput, StartSpeechSynthesisStreamCommandOutput, import("..").PollyClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
