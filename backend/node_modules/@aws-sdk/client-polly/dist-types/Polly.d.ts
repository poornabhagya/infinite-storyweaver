...
export interface Polly {
     ...
     */
    deleteLexicon(args: DeleteLexiconCommandInput, options?: PollyRequestOptions): Promise<DeleteLexiconCommandOutput>;
    deleteLexicon(args: DeleteLexiconCommandInput, cb: (err: any, data?: DeleteLexiconCommandOutput) => void): void;
    deleteLexicon(args: DeleteLexiconCommandInput, options: PollyRequestOptions, cb: (err: any, data?: DeleteLexiconCommandOutput) => void): void;
    /**
     * @see {@link DescribeVoicesCommand}
     */
    describeVoices(): Promise<DescribeVoicesCommandOutput>;
    describeVoices(args: DescribeVoicesCommandInput, options?: PollyRequestOptions): Promise<DescribeVoicesCommandOutput>;
    describeVoices(args: DescribeVoicesCommandInput, cb: (err: any, data?: DescribeVoicesCommandOutput) => void): void;
    describeVoices(args: DescribeVoicesCommandInput, options: PollyRequestOptions, cb: (err: any, data?: DescribeVoicesCommandOutput) => void): void;
    /**
     * @see {@link GetLexiconCommand}
     */
    getLexicon(args: GetLexiconCommandInput, options?: PollyRequestOptions): Promise<GetLexiconCommandOutput>;
    getLexicon(args: GetLexiconCommandInput, cb: (err: any, data?: GetLexiconCommandOutput) => void): void;
    getLexicon(args: GetLexiconCommandInput, options: PollyRequestOptions, cb: (err: any, data?: GetLexiconCommandOutput) => void): void;
    /**
     * @see {@link GetSpeechSynthesisTaskCommand}
     */
    getSpeechSynthesisTask(args: GetSpeechSynthesisTaskCommandInput, options?: PollyRequestOptions): Promise<GetSpeechSynthesisTaskCommandOutput>;
    ...
    getSpeechSynthesisTask(args: GetSpeechSynthesisTaskCommandInput, options: PollyRequestOptions, cb: (err: any, data?: GetSpeechSynthesisTaskCommandOutput) => void): void;
    /**
     * @see {@link ListLexiconsCommand}
     */
    listLexicons(): Promise<ListLexiconsCommandOutput>;
    listLexicons(args: ListLexiconsCommandInput, options?: PollyRequestOptions): Promise<ListLexiconsCommandOutput>;
    listLexicons(args: ListLexiconsCommandInput, cb: (err: any, data?: ListLexiconsCommandOutput) => void): void;
    listLexicons(args: ListLexiconsCommandInput, options: PollyRequestOptions, cb: (err: any, data?: ListLexiconsCommandOutput) => void): void;
    /**
     * @see {@link ListSpeechSynthesisTasksCommand}
     */
    listSpeechSynthesisTasks(): Promise<ListSpeechSynthesisTasksCommandOutput>;
    listSpeechSynthesisTasks(args: ListSpeechSynthesisTasksCommandInput, options?: PollyRequestOptions): Promise<ListSpeechSynthesisTasksCommandOutput>;
    ...
    listSpeechSynthesisTasks(args: ListSpeechSynthesisTasksCommandInput, options: PollyRequestOptions, cb: (err: any, data?: ListSpeechSynthesisTasksCommandOutput) => void): void;
    /**
     * @see {@link PutLexiconCommand}
     */
    putLexicon(args: PutLexiconCommandInput, options?: PollyRequestOptions): Promise<PutLexiconCommandOutput>;
    putLexicon(args: PutLexiconCommandInput, cb: (err: any, data?: PutLexiconCommandOutput) => void): void;
    putLexicon(args: PutLexiconCommandInput, options: PollyRequestOptions, cb: (err: any, data?: PutLexiconCommandOutput) => void): void;
    /**
     * @see {@link StartSpeechSynthesisStreamCommand}
     */
    startSpeechSynthesisStream(args: StartSpeechSynthesisStreamCommandInput, options?: PollyRequestOptions): Promise<StartSpeechSynthesisStreamCommandOutput>;
    ...
    startSpeechSynthesisStream(args: StartSpeechSynthesisStreamCommandInput, options: PollyRequestOptions, cb: (err: any, data?: StartSpeechSynthesisStreamCommandOutput) => void): void;
    /**
     * @see {@link StartSpeechSynthesisTaskCommand}
     */
    startSpeechSynthesisTask(args: StartSpeechSynthesisTaskCommandInput, options?: PollyRequestOptions): Promise<StartSpeechSynthesisTaskCommandOutput>;
    ...
    startSpeechSynthesisTask(args: StartSpeechSynthesisTaskCommandInput, options: PollyRequestOptions, cb: (err: any, data?: StartSpeechSynthesisTaskCommandOutput) => void): void;
    /**
     * @see {@link SynthesizeSpeechCommand}
     */
    synthesizeSpeech(args: SynthesizeSpeechCommandInput, options?: PollyRequestOptions): Promise<SynthesizeSpeechCommandOutput>;
    synthesizeSpeech(args: SynthesizeSpeechCommandInput, cb: (err: any, data?: SynthesizeSpeechCommandOutput) => void): void;
    synthesizeSpeech(args: SynthesizeSpeechCommandInput, options: PollyRequestOptions, cb: (err: any, data?: SynthesizeSpeechCommandOutput) => void): void;
    /**
     * @see {@link ListSpeechSynthesisTasksCommand}
